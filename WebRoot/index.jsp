		...
		<div id="main_container">
			...
			<div id="main_content">
				...
				<div class="crumb_navigation">
					Navigation:
					<span class="current">Main Page</span>
							...
							<s:if test="#stu.odd">
								<li class="odd">
									<a
										...
										${commodityClass.commodityClassName} </a>
								</li>
							</s:if>
							<s:else>
								<li class="even">
				...
				<div class="center_content">
					<!--  <div class="center_title_bar">Commodities</div>-->
						...
						<div class="prod_box">
							...
							<div class="center_prod_box">
								<div class="product_title">
									<a
										href="showCommodity.action?commodityID=${commodity.commodityId}">${commodity.commodityName}</a>
								</div>
								<div class="product_img">
									<a
										href="showCommodity.action?commodityID=${commodity.commodityId}"><img
											src="showImg.action?commodityID=${commodity.commodityId}"
											alt="" title="" border="0" />
									</a>
								</div>
								<div class="prod_price">
									<!--<span class="reduce">${commodity.commodityPrice}</span>-->
									<span class="price">${commodity.fcPrice}</span> euro/h
								</div>
							</div>
							...
							<div class="prod_details_tab">
								...
								<a
									href="showCommodity.action?commodityID=${commodity.commodityId}"
