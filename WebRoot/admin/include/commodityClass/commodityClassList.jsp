...
border=0>
  <TBODY>
  <TR>
    <TH colSpan=2 height=24>【List of Place Classes】</TH>  </TR>
  <TR>
    <TD class=forumrow width="30%" height=24><div align="center">Class ID</div></TD>
  <TD class=forumrowhighlight width="70%" 
      height=24><div align="center">Class Name</div></TD>
  </TR>
  ...
  <TR>
    ...
    <s:if test="page.hasPrePage">
		<a href="findAllCommodityClass.action?currentPage=1">first page</a>
		<a href="findAllCommodityClass.action?currentPage=${currentPage - 1}">previous page</a>
	</s:if>
	<s:else>
		<EM>first page</EM>
		<EM>previous page</EM>
	...
	<s:if test="page.hasNextPage">
		<a href="findAllCommodityClass.action?currentPage=${currentPage + 1}">next page</a>
		<a href="findAllCommodityClass.action?currentPage=${page.totalPage}">last page</a>
	</s:if>
	<s:else>
		<EM>next page</EM>
		<EM>last page</EM>
